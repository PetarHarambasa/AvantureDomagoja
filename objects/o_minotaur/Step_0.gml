switch (state)
{
	case "chase":
	#region Chase State
		set_state_sprite(spr_Mino_Walk,0);
	...
	case "attack":
		#region  Attack State
		set_state_sprite(spr_Mino_Attack,0);
		
		if animation_hit_frame(3)
		{
			create_hitbox(x,y, self, spr_Mino_attack_dmg, 4,4,7, image_xscale);
		}
		#endregion
		break;
		...
		#region KnockBack State
			knockback_state(spr_Mino_hit,"chase");
		#endregion
		break;
